...
Custom field definition system that allows users to define structured data fields for entries within each vault. Supports multiple field types with configurable options and validation.
