...
Full-text search capability for entries within vaults using SQLite FTS5. Enables users to quickly find entries by searching title and description content with real-time filtering, prefix matching, case-insensitive search, and highlighted results.
